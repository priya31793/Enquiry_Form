...
<!--
<button class="button button3" onclick="goBack()" style="float:right;">Go Back</button>
<script>
function goBack() {
    window.history.back();
}
...
<!--<tr>
    <td bgcolor=""><strong>Student Name</strong></td>
    <td bgcolor=""><strong>Student Id</strong></td>
	<td bgcolor=""><strong>Department</strong></td>
	<td bgcolor=""><strong>Feedback</strong></td>
		<td bgcolor="#CCCCCC"><strong>Update</strong></td></tr>-->
<?php 
